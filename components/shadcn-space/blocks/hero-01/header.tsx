...
import { SITE_NAME, FOOTER } from "@/lib/site-data";
...
const AriseButton = ({ className }: { className?: string }) => (
  <Button asChild className={cn("relative text-sm font-semibold rounded-full h-10 p-1 ps-4 pe-12 group transition-all duration-500 hover:ps-12 hover:pe-4 w-fit overflow-hidden tracking-widest", className, "cursor-pointer")}>
    <a href="#home">
    ...
    >
      ...
      >
        ...
        <div className="flex gap-4">
          <AriseButton className="hidden lg:flex" />
